...
[![CI](https://github.com/buluma/ansible-role-kubernetes/workflows/CI/badge.svg?event=push)](https://github.com/buluma/ansible-role-kubernetes/actions?query=workflow%3ACI) [![Release](https://github.com/buluma/ansible-role-kubernetes/actions/workflows/release.yml/badge.svg)](https://github.com/buluma/ansible-role-kubernetes/actions/workflows/release.yml) ![Ansible Role](https://img.shields.io/ansible/role/d/54986?color=blue)
