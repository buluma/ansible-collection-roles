...
[![CI](https://github.com/buluma/ansible-role-filebeat/workflows/CI/badge.svg?event=push)](https://github.com/buluma/ansible-role-filebeat/actions?query=workflow%3ACI) [![Release](https://github.com/buluma/ansible-role-filebeat/actions/workflows/release.yml/badge.svg)](https://github.com/buluma/ansible-role-filebeat/actions/workflows/release.yml) ![Ansible Role](https://img.shields.io/ansible/role/d/54982?color=blue)
