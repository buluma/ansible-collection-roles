...
--
-- Table structure for table `{{joomla_site_dbprefix}}assets`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}assets` (
...
--
-- Dumping data for table `{{joomla_site_dbprefix}}assets`
--

INSERT INTO `{{joomla_site_dbprefix}}assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `{{joomla_site_dbprefix}}associations`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}associations` (
...
--
-- Table structure for table `{{joomla_site_dbprefix}}banners`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}banners` (
...
--
-- Table structure for table `{{joomla_site_dbprefix}}banner_clients`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `{{joomla_site_dbprefix}}banner_tracks`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}banner_tracks` (
...
--
-- Table structure for table `{{joomla_site_dbprefix}}categories`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'FK to the {{joomla_site_dbprefix}}assets table.',
...
--
-- Dumping data for table `{{joomla_site_dbprefix}}categories`
--

INSERT INTO `{{joomla_site_dbprefix}}categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Table structure for table `{{joomla_site_dbprefix}}contact_details`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `{{joomla_site_dbprefix}}content`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}content` (
...
--
-- Table structure for table `{{joomla_site_dbprefix}}content_frontpage`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}content_frontpage` (
...
--
-- Table structure for table `{{joomla_site_dbprefix}}content_rating`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}content_rating` (
  `content_id` int(11) NOT NULL DEFAULT 0,
...
--
-- Table structure for table `{{joomla_site_dbprefix}}content_types`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}content_types` (
...
--
-- Dumping data for table `{{joomla_site_dbprefix}}content_types`
--

INSERT INTO `{{joomla_site_dbprefix}}content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
(1, 'Article', 'com_content.article', '{"special":{"dbtable":"{{joomla_site_dbprefix}}content","key":"id","type":"Content","prefix":"JTable","config":"array()"},"common":{"dbtable":"{{joomla_site_dbprefix}}ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"title","core_state":"state","core_alias":"alias","core_created_time":"created","core_modified_time":"modified","core_body":"introtext", "core_hits":"hits","core_publish_up":"publish_up","core_publish_down":"publish_down","core_access":"access", "core_params":"attribs", "core_featured":"featured", "core_metadata":"metadata", "core_language":"language", "core_images":"images", "core_urls":"urls", "core_version":"version", "core_ordering":"ordering", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"catid", "core_xreference":"xreference", "asset_id":"asset_id"}, "special":{"fulltext":"fulltext"}}', 'ContentHelperRoute::getArticleRoute', '{"formFile":"administrator\\/components\\/com_content\\/models\\/forms\\/article.xml", "hideFields":["asset_id","checked_out","checked_out_time","version"],"ignoreChanges":["modified_by", "modified", "checked_out", "checked_out_time", "version", "hits"],"convertToInt":["publish_up", "publish_down", "featured", "ordering"],"displayLookup":[{"sourceColumn":"catid","targetTable":"{{joomla_site_dbprefix}}categories","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"created_by","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"access","targetTable":"{{joomla_site_dbprefix}}viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_by","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"} ]}'),
(2, 'Contact', 'com_contact.contact', '{"special":{"dbtable":"{{joomla_site_dbprefix}}contact_details","key":"id","type":"Contact","prefix":"ContactTable","config":"array()"},"common":{"dbtable":"{{joomla_site_dbprefix}}ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"name","core_state":"published","core_alias":"alias","core_created_time":"created","core_modified_time":"modified","core_body":"address", "core_hits":"hits","core_publish_up":"publish_up","core_publish_down":"publish_down","core_access":"access", "core_params":"params", "core_featured":"featured", "core_metadata":"metadata", "core_language":"language", "core_images":"image", "core_urls":"webpage", "core_version":"version", "core_ordering":"ordering", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"catid", "core_xreference":"xreference", "asset_id":"null"}, "special":{"con_position":"con_position","suburb":"suburb","state":"state","country":"country","postcode":"postcode","telephone":"telephone","fax":"fax","misc":"misc","email_to":"email_to","default_con":"default_con","user_id":"user_id","mobile":"mobile","sortname1":"sortname1","sortname2":"sortname2","sortname3":"sortname3"}}', 'ContactHelperRoute::getContactRoute', '{"formFile":"administrator\\/components\\/com_contact\\/models\\/forms\\/contact.xml","hideFields":["default_con","checked_out","checked_out_time","version","xreference"],"ignoreChanges":["modified_by", "modified", "checked_out", "checked_out_time", "version", "hits"],"convertToInt":["publish_up", "publish_down", "featured", "ordering"], "displayLookup":[ {"sourceColumn":"created_by","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"catid","targetTable":"{{joomla_site_dbprefix}}categories","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_by","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"access","targetTable":"{{joomla_site_dbprefix}}viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"user_id","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"} ] }'),
(3, 'Newsfeed', 'com_newsfeeds.newsfeed', '{"special":{"dbtable":"{{joomla_site_dbprefix}}newsfeeds","key":"id","type":"Newsfeed","prefix":"NewsfeedsTable","config":"array()"},"common":{"dbtable":"{{joomla_site_dbprefix}}ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"name","core_state":"published","core_alias":"alias","core_created_time":"created","core_modified_time":"modified","core_body":"description", "core_hits":"hits","core_publish_up":"publish_up","core_publish_down":"publish_down","core_access":"access", "core_params":"params", "core_featured":"featured", "core_metadata":"metadata", "core_language":"language", "core_images":"images", "core_urls":"link", "core_version":"version", "core_ordering":"ordering", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"catid", "core_xreference":"xreference", "asset_id":"null"}, "special":{"numarticles":"numarticles","cache_time":"cache_time","rtl":"rtl"}}', 'NewsfeedsHelperRoute::getNewsfeedRoute', '{"formFile":"administrator\\/components\\/com_newsfeeds\\/models\\/forms\\/newsfeed.xml","hideFields":["asset_id","checked_out","checked_out_time","version"],"ignoreChanges":["modified_by", "modified", "checked_out", "checked_out_time", "version", "hits"],"convertToInt":["publish_up", "publish_down", "featured", "ordering"],"displayLookup":[{"sourceColumn":"catid","targetTable":"{{joomla_site_dbprefix}}categories","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"created_by","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"access","targetTable":"{{joomla_site_dbprefix}}viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_by","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"} ]}'),
(4, 'User', 'com_users.user', '{"special":{"dbtable":"{{joomla_site_dbprefix}}users","key":"id","type":"User","prefix":"JTable","config":"array()"},"common":{"dbtable":"{{joomla_site_dbprefix}}ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"name","core_state":"null","core_alias":"username","core_created_time":"registerdate","core_modified_time":"lastvisitDate","core_body":"null", "core_hits":"null","core_publish_up":"null","core_publish_down":"null","access":"null", "core_params":"params", "core_featured":"null", "core_metadata":"null", "core_language":"null", "core_images":"null", "core_urls":"null", "core_version":"null", "core_ordering":"null", "core_metakey":"null", "core_metadesc":"null", "core_catid":"null", "core_xreference":"null", "asset_id":"null"}, "special":{}}', 'UsersHelperRoute::getUserRoute', ''),
(5, 'Article Category', 'com_content.category', '{"special":{"dbtable":"{{joomla_site_dbprefix}}categories","key":"id","type":"Category","prefix":"JTable","config":"array()"},"common":{"dbtable":"{{joomla_site_dbprefix}}ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"title","core_state":"published","core_alias":"alias","core_created_time":"created_time","core_modified_time":"modified_time","core_body":"description", "core_hits":"hits","core_publish_up":"null","core_publish_down":"null","core_access":"access", "core_params":"params", "core_featured":"null", "core_metadata":"metadata", "core_language":"language", "core_images":"null", "core_urls":"null", "core_version":"version", "core_ordering":"null", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"parent_id", "core_xreference":"null", "asset_id":"asset_id"}, "special":{"parent_id":"parent_id","lft":"lft","rgt":"rgt","level":"level","path":"path","extension":"extension","note":"note"}}', 'ContentHelperRoute::getCategoryRoute', '{"formFile":"administrator\\/components\\/com_categories\\/models\\/forms\\/category.xml", "hideFields":["asset_id","checked_out","checked_out_time","version","lft","rgt","level","path","extension"], "ignoreChanges":["modified_user_id", "modified_time", "checked_out", "checked_out_time", "version", "hits", "path"],"convertToInt":["publish_up", "publish_down"], "displayLookup":[{"sourceColumn":"created_user_id","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"access","targetTable":"{{joomla_site_dbprefix}}viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_user_id","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"parent_id","targetTable":"{{joomla_site_dbprefix}}categories","targetColumn":"id","displayColumn":"title"}]}'),
(6, 'Contact Category', 'com_contact.category', '{"special":{"dbtable":"{{joomla_site_dbprefix}}categories","key":"id","type":"Category","prefix":"JTable","config":"array()"},"common":{"dbtable":"{{joomla_site_dbprefix}}ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"title","core_state":"published","core_alias":"alias","core_created_time":"created_time","core_modified_time":"modified_time","core_body":"description", "core_hits":"hits","core_publish_up":"null","core_publish_down":"null","core_access":"access", "core_params":"params", "core_featured":"null", "core_metadata":"metadata", "core_language":"language", "core_images":"null", "core_urls":"null", "core_version":"version", "core_ordering":"null", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"parent_id", "core_xreference":"null", "asset_id":"asset_id"}, "special":{"parent_id":"parent_id","lft":"lft","rgt":"rgt","level":"level","path":"path","extension":"extension","note":"note"}}', 'ContactHelperRoute::getCategoryRoute', '{"formFile":"administrator\\/components\\/com_categories\\/models\\/forms\\/category.xml", "hideFields":["asset_id","checked_out","checked_out_time","version","lft","rgt","level","path","extension"], "ignoreChanges":["modified_user_id", "modified_time", "checked_out", "checked_out_time", "version", "hits", "path"],"convertToInt":["publish_up", "publish_down"], "displayLookup":[{"sourceColumn":"created_user_id","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"access","targetTable":"{{joomla_site_dbprefix}}viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_user_id","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"parent_id","targetTable":"{{joomla_site_dbprefix}}categories","targetColumn":"id","displayColumn":"title"}]}'),
(7, 'Newsfeeds Category', 'com_newsfeeds.category', '{"special":{"dbtable":"{{joomla_site_dbprefix}}categories","key":"id","type":"Category","prefix":"JTable","config":"array()"},"common":{"dbtable":"{{joomla_site_dbprefix}}ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"title","core_state":"published","core_alias":"alias","core_created_time":"created_time","core_modified_time":"modified_time","core_body":"description", "core_hits":"hits","core_publish_up":"null","core_publish_down":"null","core_access":"access", "core_params":"params", "core_featured":"null", "core_metadata":"metadata", "core_language":"language", "core_images":"null", "core_urls":"null", "core_version":"version", "core_ordering":"null", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"parent_id", "core_xreference":"null", "asset_id":"asset_id"}, "special":{"parent_id":"parent_id","lft":"lft","rgt":"rgt","level":"level","path":"path","extension":"extension","note":"note"}}', 'NewsfeedsHelperRoute::getCategoryRoute', '{"formFile":"administrator\\/components\\/com_categories\\/models\\/forms\\/category.xml", "hideFields":["asset_id","checked_out","checked_out_time","version","lft","rgt","level","path","extension"], "ignoreChanges":["modified_user_id", "modified_time", "checked_out", "checked_out_time", "version", "hits", "path"],"convertToInt":["publish_up", "publish_down"], "displayLookup":[{"sourceColumn":"created_user_id","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"access","targetTable":"{{joomla_site_dbprefix}}viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_user_id","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"parent_id","targetTable":"{{joomla_site_dbprefix}}categories","targetColumn":"id","displayColumn":"title"}]}'),
(8, 'Tag', 'com_tags.tag', '{"special":{"dbtable":"{{joomla_site_dbprefix}}tags","key":"tag_id","type":"Tag","prefix":"TagsTable","config":"array()"},"common":{"dbtable":"{{joomla_site_dbprefix}}ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"title","core_state":"published","core_alias":"alias","core_created_time":"created_time","core_modified_time":"modified_time","core_body":"description", "core_hits":"hits","core_publish_up":"null","core_publish_down":"null","core_access":"access", "core_params":"params", "core_featured":"featured", "core_metadata":"metadata", "core_language":"language", "core_images":"images", "core_urls":"urls", "core_version":"version", "core_ordering":"null", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"null", "core_xreference":"null", "asset_id":"null"}, "special":{"parent_id":"parent_id","lft":"lft","rgt":"rgt","level":"level","path":"path"}}', 'TagsHelperRoute::getTagRoute', '{"formFile":"administrator\\/components\\/com_tags\\/models\\/forms\\/tag.xml", "hideFields":["checked_out","checked_out_time","version", "lft", "rgt", "level", "path", "urls", "publish_up", "publish_down"],"ignoreChanges":["modified_user_id", "modified_time", "checked_out", "checked_out_time", "version", "hits", "path"],"convertToInt":["publish_up", "publish_down"], "displayLookup":[{"sourceColumn":"created_user_id","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"}, {"sourceColumn":"access","targetTable":"{{joomla_site_dbprefix}}viewlevels","targetColumn":"id","displayColumn":"title"}, {"sourceColumn":"modified_user_id","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"}]}'),
(9, 'Banner', 'com_banners.banner', '{"special":{"dbtable":"{{joomla_site_dbprefix}}banners","key":"id","type":"Banner","prefix":"BannersTable","config":"array()"},"common":{"dbtable":"{{joomla_site_dbprefix}}ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"name","core_state":"published","core_alias":"alias","core_created_time":"created","core_modified_time":"modified","core_body":"description", "core_hits":"null","core_publish_up":"publish_up","core_publish_down":"publish_down","core_access":"access", "core_params":"params", "core_featured":"null", "core_metadata":"metadata", "core_language":"language", "core_images":"images", "core_urls":"link", "core_version":"version", "core_ordering":"ordering", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"catid", "core_xreference":"null", "asset_id":"null"}, "special":{"imptotal":"imptotal", "impmade":"impmade", "clicks":"clicks", "clickurl":"clickurl", "custombannercode":"custombannercode", "cid":"cid", "purchase_type":"purchase_type", "track_impressions":"track_impressions", "track_clicks":"track_clicks"}}', '','{"formFile":"administrator\\/components\\/com_banners\\/models\\/forms\\/banner.xml", "hideFields":["checked_out","checked_out_time","version", "reset"],"ignoreChanges":["modified_by", "modified", "checked_out", "checked_out_time", "version", "imptotal", "impmade", "reset"], "convertToInt":["publish_up", "publish_down", "ordering"], "displayLookup":[{"sourceColumn":"catid","targetTable":"{{joomla_site_dbprefix}}categories","targetColumn":"id","displayColumn":"title"}, {"sourceColumn":"cid","targetTable":"{{joomla_site_dbprefix}}banner_clients","targetColumn":"id","displayColumn":"name"}, {"sourceColumn":"created_by","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"modified_by","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"} ]}'),
(10, 'Banners Category', 'com_banners.category', '{"special":{"dbtable":"{{joomla_site_dbprefix}}categories","key":"id","type":"Category","prefix":"JTable","config":"array()"},"common":{"dbtable":"{{joomla_site_dbprefix}}ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"title","core_state":"published","core_alias":"alias","core_created_time":"created_time","core_modified_time":"modified_time","core_body":"description", "core_hits":"hits","core_publish_up":"null","core_publish_down":"null","core_access":"access", "core_params":"params", "core_featured":"null", "core_metadata":"metadata", "core_language":"language", "core_images":"null", "core_urls":"null", "core_version":"version", "core_ordering":"null", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"parent_id", "core_xreference":"null", "asset_id":"asset_id"}, "special": {"parent_id":"parent_id","lft":"lft","rgt":"rgt","level":"level","path":"path","extension":"extension","note":"note"}}','','{"formFile":"administrator\\/components\\/com_categories\\/models\\/forms\\/category.xml", "hideFields":["asset_id","checked_out","checked_out_time","version","lft","rgt","level","path","extension"], "ignoreChanges":["modified_user_id", "modified_time", "checked_out", "checked_out_time", "version", "hits", "path"], "convertToInt":["publish_up", "publish_down"], "displayLookup":[{"sourceColumn":"created_user_id","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"access","targetTable":"{{joomla_site_dbprefix}}viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_user_id","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"parent_id","targetTable":"{{joomla_site_dbprefix}}categories","targetColumn":"id","displayColumn":"title"}]}'),
(11, 'Banner Client', 'com_banners.client', '{"special":{"dbtable":"{{joomla_site_dbprefix}}banner_clients","key":"id","type":"Client","prefix":"BannersTable"}}', '', '', '', '{"formFile":"administrator\\/components\\/com_banners\\/models\\/forms\\/client.xml", "hideFields":["checked_out","checked_out_time"], "ignoreChanges":["checked_out", "checked_out_time"], "convertToInt":[], "displayLookup":[]}'),
(12, 'User Notes', 'com_users.note', '{"special":{"dbtable":"{{joomla_site_dbprefix}}user_notes","key":"id","type":"Note","prefix":"UsersTable"}}', '', '', '', '{"formFile":"administrator\\/components\\/com_users\\/models\\/forms\\/note.xml", "hideFields":["checked_out","checked_out_time", "publish_up", "publish_down"],"ignoreChanges":["modified_user_id", "modified_time", "checked_out", "checked_out_time"], "convertToInt":["publish_up", "publish_down"],"displayLookup":[{"sourceColumn":"catid","targetTable":"{{joomla_site_dbprefix}}categories","targetColumn":"id","displayColumn":"title"}, {"sourceColumn":"created_user_id","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"}, {"sourceColumn":"user_id","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"}, {"sourceColumn":"modified_user_id","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"}]}'),
(13, 'User Notes Category', 'com_users.category', '{"special":{"dbtable":"{{joomla_site_dbprefix}}categories","key":"id","type":"Category","prefix":"JTable","config":"array()"},"common":{"dbtable":"{{joomla_site_dbprefix}}ucm_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}', '', '{"common":{"core_content_item_id":"id","core_title":"title","core_state":"published","core_alias":"alias","core_created_time":"created_time","core_modified_time":"modified_time","core_body":"description", "core_hits":"hits","core_publish_up":"null","core_publish_down":"null","core_access":"access", "core_params":"params", "core_featured":"null", "core_metadata":"metadata", "core_language":"language", "core_images":"null", "core_urls":"null", "core_version":"version", "core_ordering":"null", "core_metakey":"metakey", "core_metadesc":"metadesc", "core_catid":"parent_id", "core_xreference":"null", "asset_id":"asset_id"}, "special":{"parent_id":"parent_id","lft":"lft","rgt":"rgt","level":"level","path":"path","extension":"extension","note":"note"}}', '', '{"formFile":"administrator\\/components\\/com_categories\\/models\\/forms\\/category.xml", "hideFields":["checked_out","checked_out_time","version","lft","rgt","level","path","extension"], "ignoreChanges":["modified_user_id", "modified_time", "checked_out", "checked_out_time", "version", "hits", "path"], "convertToInt":["publish_up", "publish_down"], "displayLookup":[{"sourceColumn":"created_user_id","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"}, {"sourceColumn":"access","targetTable":"{{joomla_site_dbprefix}}viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"modified_user_id","targetTable":"{{joomla_site_dbprefix}}users","targetColumn":"id","displayColumn":"name"},{"sourceColumn":"parent_id","targetTable":"{{joomla_site_dbprefix}}categories","targetColumn":"id","displayColumn":"title"}]}');

-- --------------------------------------------------------

--
-- Table structure for table `{{joomla_site_dbprefix}}contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}contentitem_tag_map` (
  `type_alias` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `{{joomla_site_dbprefix}}core_log_searches`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}core_log_searches` (
...
--
-- Table structure for table `{{joomla_site_dbprefix}}extensions`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}extensions` (
...
--
-- Dumping data for table `{{joomla_site_dbprefix}}extensions`
--

INSERT INTO `{{joomla_site_dbprefix}}extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_filters`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_filters` (
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_links`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_links` (
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_links_terms0` (
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT 0,
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `{{joomla_site_dbprefix}}finder_taxonomy`
--

INSERT INTO `{{joomla_site_dbprefix}}finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `{{joomla_site_dbprefix}}finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_terms`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_terms` (
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `{{joomla_site_dbprefix}}finder_terms_common`
--

INSERT INTO `{{joomla_site_dbprefix}}finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_tokens`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT 0,
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT 0,
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `{{joomla_site_dbprefix}}finder_types`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `{{joomla_site_dbprefix}}languages`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}languages` (
...
--
-- Dumping data for table `{{joomla_site_dbprefix}}languages`
--

INSERT INTO `{{joomla_site_dbprefix}}languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `{{joomla_site_dbprefix}}menu`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `menutype` varchar(24) NOT NULL COMMENT 'The type of menu this item belongs to. FK to {{joomla_site_dbprefix}}menu_types.menutype',
  ...
  `component_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'FK to {{joomla_site_dbprefix}}extensions.id',
  `checked_out` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'FK to {{joomla_site_dbprefix}}users.id',
...
--
-- Dumping data for table `{{joomla_site_dbprefix}}menu`
--

INSERT INTO `{{joomla_site_dbprefix}}menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `{{joomla_site_dbprefix}}menu_types`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `{{joomla_site_dbprefix}}menu_types`
--

INSERT INTO `{{joomla_site_dbprefix}}menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `{{joomla_site_dbprefix}}messages`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}messages` (
...
--
-- Table structure for table `{{joomla_site_dbprefix}}messages_cfg`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}messages_cfg` (
...
--
-- Table structure for table `{{joomla_site_dbprefix}}modules`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'FK to the {{joomla_site_dbprefix}}assets table.',
...
--
-- Dumping data for table `{{joomla_site_dbprefix}}modules`
--

INSERT INTO `{{joomla_site_dbprefix}}modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `{{joomla_site_dbprefix}}modules_menu`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}modules_menu` (
...
--
-- Dumping data for table `{{joomla_site_dbprefix}}modules_menu`
--

INSERT INTO `{{joomla_site_dbprefix}}modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `{{joomla_site_dbprefix}}newsfeeds`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT 0,
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `{{joomla_site_dbprefix}}overrider`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}overrider` (
...
--
-- Table structure for table `{{joomla_site_dbprefix}}postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}postinstall_messages` (
  `postinstall_message_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `extension_id` bigint(20) NOT NULL DEFAULT 700 COMMENT 'FK to {{joomla_site_dbprefix}}extensions',
...
INSERT INTO `{{joomla_site_dbprefix}}postinstall_messages` (`extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `{{joomla_site_dbprefix}}redirect_links`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `{{joomla_site_dbprefix}}schemas`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}schemas` (
...
--
-- Table structure for table `{{joomla_site_dbprefix}}session`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}session` (
...
--
-- Table structure for table `{{joomla_site_dbprefix}}tags`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT 0,
  `lft` int(11) NOT NULL DEFAULT 0,
  `rgt` int(11) NOT NULL DEFAULT 0,
...
--
-- Dumping data for table `{{joomla_site_dbprefix}}tags`
--

INSERT INTO `{{joomla_site_dbprefix}}tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', '', '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `{{joomla_site_dbprefix}}template_styles`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `{{joomla_site_dbprefix}}template_styles`
--

INSERT INTO `{{joomla_site_dbprefix}}template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `{{joomla_site_dbprefix}}ucm_base`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}ucm_base` (
...
--
-- Table structure for table `{{joomla_site_dbprefix}}ucm_content`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}ucm_content` (
  ...
  `asset_id` int(10) unsigned COMMENT 'FK to the {{joomla_site_dbprefix}}assets table.',
...
--
-- Table structure for table `{{joomla_site_dbprefix}}ucm_history`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}ucm_history` (
...
--
-- Table structure for table `{{joomla_site_dbprefix}}updates`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}updates` (
...
--
-- Table structure for table `{{joomla_site_dbprefix}}update_sites`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}update_sites` (
...
--
-- Dumping data for table `{{joomla_site_dbprefix}}update_sites`
--

INSERT INTO `{{joomla_site_dbprefix}}update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
...
--
-- Table structure for table `{{joomla_site_dbprefix}}update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}update_sites_extensions` (
...
--
-- Dumping data for table `{{joomla_site_dbprefix}}update_sites_extensions`
--

INSERT INTO `{{joomla_site_dbprefix}}update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(4, 28);
...
--
-- Table structure for table `{{joomla_site_dbprefix}}usergroups`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `{{joomla_site_dbprefix}}usergroups`
--

INSERT INTO `{{joomla_site_dbprefix}}usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `{{joomla_site_dbprefix}}users`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `{{joomla_site_dbprefix}}user_keys`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `{{joomla_site_dbprefix}}user_notes`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT 0,
  `catid` int(10) unsigned NOT NULL DEFAULT 0,
...
--
-- Table structure for table `{{joomla_site_dbprefix}}user_profiles`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}user_profiles` (
...
--
-- Table structure for table `{{joomla_site_dbprefix}}user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Foreign Key to {{joomla_site_dbprefix}}users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Foreign Key to {{joomla_site_dbprefix}}usergroups.id',
...
--
-- Table structure for table `{{joomla_site_dbprefix}}viewlevels`
--

CREATE TABLE IF NOT EXISTS `{{joomla_site_dbprefix}}viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT 0,
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `{{joomla_site_dbprefix}}viewlevels`
--

INSERT INTO `{{joomla_site_dbprefix}}viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
