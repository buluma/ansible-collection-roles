...
This role [refers to a version](https://github.com/buluma/ansible-role-go/blob/master/defaults/main.yml) released by Go. Check the released version(s) here:
